...
// Color Palettes - 44 colors each (+ 1 no-color = 45 = 9x5 grid)
const EVENT_COLOR_PALETTES = {
  vibrant: [
    '#d50000', '#ff1744', '#f44336', '#e53935', '#ff5722',
    '#ff6e40', '#ff9800', '#ffa726', '#ffc107',
    '#ffeb3b', '#ffee58', '#cddc39', '#c0ca33', '#8bc34a',
    '#66bb6a', '#4caf50', '#00e676', '#1de9b6',
    '#009688', '#26a69a', '#00e5ff', '#00bcd4', '#00b0ff',
    '#03a9f4', '#29b6f6', '#2196f3', '#2979ff',
    '#3d5afe', '#651fff', '#7c4dff', '#3f51b5', '#5c6bc0',
    '#673ab7', '#9c27b0', '#ab47bc', '#e91e63',
    '#ec407a', '#ff4081', '#f50057', '#795548', '#8d6e63',
    '#9e9e9e', '#78909c', '#607d8b',
  ],
  pastel: [
    '#f8bbd9', '#f48fb1', '#f06292', '#ec407a', '#e1bee7',
    '#ce93d8', '#ba68c8', '#d1c4e9', '#b39ddb',
    '#9fa8da', '#c5cae9', '#bbdefb', '#90caf9', '#64b5f6',
    '#42a5f5', '#4fc3f7', '#b3e5fc', '#81d4fa',
    '#b2ebf2', '#80deea', '#4dd0e1', '#26c6da', '#a7ffeb',
    '#64ffda', '#b9f6ca', '#a5d6a7', '#81c784',
    '#c8e6c9', '#dcedc8', '#f0f4c3', '#e6ee9c', '#fff9c4',
    '#fff59d', '#fff176', '#ffee58', '#ffe082',
    '#ffd54f', '#ffcc80', '#ffab91', '#ff8a65', '#ffccbc',
    '#d7ccc8', '#bcaaa4', '#ffe0b2', '#ffd180',
  ],
  dark: [
    '#b71c1c', '#c62828', '#d32f2f', '#e53935', '#880e4f',
    '#ad1457', '#c2185b', '#4a148c', '#6a1b9a',
    '#7b1fa2', '#8e24aa', '#311b92', '#4527a0', '#512da8',
    '#5e35b1', '#0d47a1', '#1565c0', '#1976d2',
    '#1e88e5', '#01579b', '#0277bd', '#00838f', '#004d40',
    '#00695c', '#00796b', '#00897b', '#1b5e20',
    '#2e7d32', '#388e3c', '#43a047', '#33691e', '#558b2f',
    '#689f38', '#827717', '#9e9d24', '#f57f17',
    '#ff8f00', '#e65100', '#3e2723', '#4e342e', '#5d4037',
    '#263238', '#37474f', '#455a64', '#212121',
  ],
};
